          ...
          builder: (context, state){
            ...
            return Scaffold(
                ...
                body: Padding(
                  ...
                  child: ConditionalBuilder(
                    ...
                    builder:(context)=> ListView.separated(
                      itemBuilder: (context, index)=>MyTripsCart(index: index, trip: cubit.driverTrips[index]),
                ...
                floatingActionButton: FloatingActionButton(
                  onPressed: (){
                    if(CacheHelper.sharedPreferences.getString('isDriverCompleteData')=='false'){
...
class MyTripsCart extends StatelessWidget {
  MyTripsCart({Key? key,required this.trip, required this.index}) : super(key: key);
  int index;
  TripModel trip;
  Color getColor(){
