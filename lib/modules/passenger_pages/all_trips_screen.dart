              ...
              child: ConditionalBuilder(
                ...
                builder: (context) => ListView.separated(
                  itemBuilder: (context, index) =>
                      AllTripsCart(index: index, trip: cubit.allTrips[index]),
...
class AllTripsCart extends StatelessWidget {
  AllTripsCart({Key? key, required this.index, required this.trip})
      : super(key: key);
  int index;
  TripModel trip;
            ...
            child: Row(
              ...
              children: [
                ...
                CustomButton(
                    ...
                    fontSize: 14,
                    color:
                        trip.isApplied == true ? Colors.grey : secondaryColor,
                      ...
                      children: [
                        ...
                        if (AppCubit.get(context).allPromotions.isNotEmpty)
                          UserInfoItem(
                            title: 'Promotion',
                            body:
                                '${AppCubit.get(context).allPromotions[0].discount}\$',
                          ),
                        // RatingBar.builder(
                        //   initialRating: 3,
                        //   itemSize: 20.sp,
