  ...
  void cancelMyTrip(TripModel trip) {
    FirebaseFirestore.instance
      ...
      FirebaseFirestore.instance
        ...
        passengers -= 1;
        trip.passengersNumbersLogin =
            passengers < 0 ? '0' : passengers.toString();
        FirebaseFirestore.instance
            .collection('trips')
            .doc(trip.id)
            .update(trip.toMap());
        ...
        showToast(
            text: 'Trip Canceled Successfully', state: ToastStates.WARNING);
  ...
  void getAllPromotions() {
    ...
    FirebaseFirestore.instance
      ...
      event.docs.forEach((element) {
        ...
        if (promotion.id == CacheHelper.getData(key: 'uId') &&
            promotion.id != null) {
